 ...
 * Calendar date: Year (2015) ? 
Month (1-12) (6) ? 
Day.fraction (9.000000) ? 
Time: Hours (0) ? 
Minutes (0) ? 
Seconds (0.000000) ? 
[extrapolated deltaT] 2015 June 9 Tuesday  0h 01m 16.459s  TDT
2015 June 9 Tuesday  0h 00m 00.000s  UT
Julian day 2457182.5000000
Enter interval between tabulations in days (1.000000) ? 
Number of tabulations to display (1) ? 0
Planet number 0-9 or 88 to read star, 99 to read orbit (0) ? 1
 ...
 * @params double sec
 * @params int ntab
 * @params int objnum	0=sun, 1=mercury, 2=venus, 3=moon, 4=mars, 5=jupiter, 6=saturn, 7=uranus, 8=neptune, 9=pluto
 */
int main(int argc, char *argv[])
{
int i;
int cyear,month,day,hours,minutes;
double seconds;
double zgetdate(), gethms();

if (argc != 10) {
  printf("arg error.argc=%d : year month day hour minutes sec djd ntab objnum\n", argc);
  printf("    objnum:  0=sun, 1=mercury, 2=venus, 3=moon, 4=mars, 5=jupiter, 6=saturn, 7=uranus, 8=neptune, 9=pluto\n");
  exit(1);
}
cyear = atoi(argv[1]);
month = atoi(argv[2]);
...
JD = caltoj(cyear,month,day);
JD +=  (3600.0*hours + 60.0*minutes + seconds)/86400.0;
